...
export const Cards = () => {
    ...
    const initAnimation = () => {
        ...
        const Scene = new ScrollMagic.Scene({
            ...
            .on("progress", progresScroll)
            .setPin('#Capa_2')
            .addTo(controller);

        // Scene.setClassToggle('#Capa_2', 'svg-class');
        ...
        //     if(progress < 100) {
        //         if(barra){
        //             barra.style.transform = `translateX(${-100 + (progress)}%)`;
        //         }
        //     }
    ...
    const progresScroll = (event: any) => {
        ...
        let barra = document.getElementById('svg-yellow-line');
        let svg = document.getElementById('Capa_2');
        if(barra){
